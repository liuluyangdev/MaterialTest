...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null){
            actionBar.setDisplayHomeAsUpEnabled(true);//显示导航按钮（HomeAsUp按钮）
        ...
        recyclerView.setLayoutManager(layoutManager);//将GridLayoutManager设置在RecyclerView中
        adapter = new FruitAdapter(fruitList);//将水果数据传入FruitAdapter的构造函数中
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        return true;//将菜单显示出来，false则将不显示
